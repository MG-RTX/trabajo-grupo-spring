...
import com.distribuida.bar_spring.service.ClienteService;  // Cambiado a mayúscula
...
@RestController
@RequestMapping("/clientes")  // Cambiado a minúscula
public class ClienteController {

    @Autowired
    private ClienteService clienteService;  // Cambiado a mayúscula

    @GetMapping
    public ResponseEntity<List<Cliente>> findAll(){
        List<Cliente> clientes = clienteService.findAll();  // Corregido nombre de variable
